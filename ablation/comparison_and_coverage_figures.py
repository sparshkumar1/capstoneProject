...
def main() -> None:
    ...
    # Comparison panel
    fig, (ax_bar, ax_heat1, ax_heat2) = plt.subplots(1, 3, figsize=(16, 5.2), gridspec_kw={"width_ratios": [1.1, 1, 1]})
    ...
    fig.colorbar(im1, ax=ax_heat1, fraction=0.046, pad=0.04)
    fig.colorbar(im2, ax=ax_heat2, fraction=0.046, pad=0.04)
