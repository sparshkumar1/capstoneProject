...
**Table I. Pre-specified primary result (40 personas × 5 training seeds; tracking MAE, PPO+guardrail minus Constant-Same+guardrail).**
...
In Table II, all eight intervals (the primary and the seven estimates) lie inside ±0.12 and none has an upper bound below −0.20, so superiority was never established. Fig. 1 plots them against the margin.
...
[2] A. Riedmann, P. Schaper, and B. Lugrin, "Reinforcement learning in education: A systematic literature review," *Int. J. Artif. Intell. Educ.*, vol. 35, no. 5, pp. 2669–2723, 2025, doi: 10.1007/s40593-025-00494-6.
...
[7] L. Che, P. Guo, H. F. Isleem, and Z. Wang, "The necessity of multimodal feedback for learning effective pedagogical policies with reinforcement learning," *Sci. Rep.*, vol. 16, 2025, doi: 10.1038/s41598-025-29892-5 (article number not verified).
...
[9] M. Alshiekh, R. Bloem, R. Ehlers, B. Könighofer, S. Niekum, and U. Topcu, "Safe reinforcement learning via shielding," in *Proc. AAAI Conf. Artif. Intell.*, vol. 32, no. 1, 2018, doi: 10.1609/aaai.v32i1.11797 (cited for terminology only; the definition was not reopened in this study).
