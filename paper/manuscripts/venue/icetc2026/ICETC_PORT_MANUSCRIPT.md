<!-- SOURCE FOR THE ICETC BUILD (author-neutral). Not the upload file: the blinded copy is venue/ICETC_P1/P1_ICETC_BLINDED.pdf, built from this file by venue/ICETC_P1/build_icetc_docx.py. -->
...
*Authors and affiliations: withheld in this draft (anonymity rule of the target venue not verified).*
