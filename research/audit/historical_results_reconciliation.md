...
| **Evaluator Spearman $\rho$** | $\rho = 0.8358$ (or $\rho = 0.9152$) | **$\rho = 0.6975$** [95% CI: 0.372, 0.871] on Human Rater 1 | The $\rho = 0.9152$ result was measured against synthetic proxy ratings. The $\rho = 0.8358$ was calculated on an averaged composite of human + synthetic proxy ratings. | **RECONCILED**. Real human agreement is $\rho = 0.6975$ ($p = 0.0006$). The synthetic proxy agreement ($\rho = 0.9152$) must be reported explicitly as synthetic, not human. |
| **Evaluator Pearson $r$** | $r = 0.84$ – $0.88$ | **$r = 0.7290$** [95% CI: 0.449, 0.886] on Human Rater 1 | Calculated on mixed human-synthetic data in earlier reports. | **RECONCILED**. Real human linear correlation is $r = 0.7290$ ($p = 0.0003$). |
