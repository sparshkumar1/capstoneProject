#!/usr/bin/env python
"""X1-A fault-injection campaign harness (Paper 1). Protocol: research/confirmatory/X1/PROTOCOL_X1-A.md.
...
PROTOCOL_TAG = "prereg/X1-A/v1"
SUT_TAG = "release/app-repair/v1"
OUT_REL = "research/confirmatory/X1/results/x1a"
REPS = 5
...
def official(argv):
    ...
    for rel in ("research/confirmatory/X1/x1a_harness.py", "research/confirmatory/X1/PROTOCOL_X1-A.md"):
