#!/usr/bin/env python
"""X1-B-I harness: Qwen fixed-answer invariance (Paper 1). Protocol: research/confirmatory/X1/PROTOCOL_X1-B.md.
...
def sut_state():
    ...
    return {"sut_tag": SUT_TAG, "sut_commit": g("rev-parse", SUT_TAG + "^{commit}"), "head": g("rev-parse", "HEAD"),
            ...
            "decoding": "service defaults: temperature 0.1, top_p 0.9, max_new_tokens 256, no fixed seed (llama.cpp default)"}
...
def official(argv):
    ...
    for rel in ("research/confirmatory/X1/x1b_harness.py", "research/confirmatory/X1/PROTOCOL_X1-B.md", "research/confirmatory/X1/x1b_prompts.json"):
