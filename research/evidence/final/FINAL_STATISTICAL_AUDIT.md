...
| X1 campaigns | 90 / 60 / 72 runs | Deterministic repetitions, per-scenario counts | — | Engineering validation; protocols local-tagged, self-audited | Not applicable (no inference) | — | Two builds reported separately |
