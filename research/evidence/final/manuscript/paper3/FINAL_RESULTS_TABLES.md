...
**Table 2. Secondary contrasts (40 personas x 5 seeds)**: volatility +0.14877 [0.0666, 0.25445]; oscillation +0.25061 [0.13027, 0.38584]; zeroed observation +0.36982 [0.09077, 0.64148]; partner observation +0.25382 [0.10948, 0.41417]; PPO+G minus heuristic+G -0.46414 [-0.7134, -0.22601]; minus proportional+G -0.30084 [-0.51982, -0.09469]; minus oracle-rule+G -0.10698 [-0.21823, 0.00841]; guardrail on/off for Constant-Same 1.104 vs 1.000 (the frozen artifact and registry may label this contrast 'shield'; the manuscript says 'application-level rule-based guardrail') (0.10386 [-0.18375, 0.38796]); removing G1: PPO+G -0.08725 [-0.23925, 0.03782], Constant-Same+G -0.146 [-0.34944, 0.03637].
