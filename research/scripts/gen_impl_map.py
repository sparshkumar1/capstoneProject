...
# 1. implementation_map.md
impl_map = """# PrepAIred — Complete Current Implementation Map
...
"""
(audit_dir / "implementation_map.md").write_text(impl_map, encoding="utf-8")

print("Generated implementation_map.md")
