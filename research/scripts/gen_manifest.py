...
tests_data = {
    ...
    "git_commit": "9cfd34f9a0c710d540209677334ae112658a086b",
    "environment": "Windows 11 / .venv (Python 3.12.7, Torch 2.11.0+cpu)",
    "command": ".\\.venv\\Scripts\\python.exe -m pytest tests/ -q",
    "discovered_tests": 202,
    "executed_tests": 202,
    "passed": 202,
    "failed": 0,
    "skipped": 0,
    "warnings": 309,
    "execution_time_seconds": 640.03,
    "breakdown": {
        "unit_tests": 190,
...
Path("research/results/engineering_tests.json").write_text(json.dumps(tests_data, indent=2), encoding="utf-8")
...
Path("research/results/tests_current.md").write_text("\n".join(lines), encoding="utf-8")
print("Wrote tests_current.md and engineering_tests.json successfully.")
